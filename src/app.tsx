          ...
          {isGuestsInputOpen && (
            <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
              <button type="button" onClick={openGuestsModal} className='flex items-center gap-2 flex-1'>
                ...
                <span className='text-zinc-300 text-lg flex-1 text-left'>Quem estará na viagem?</span>
              </button>
          ...
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            <div className='space-y-2'>
              ...
              <p className='text-sm text-zinc-400'>
                Os ocmvidados irão receber e-mails para confirmar a participação na viagem
              </p>
            </div>
              ...
              {emailsToInvite.map(email => {
                return (
                  <div key={email} className='py-1.5 px-2.5 rounded-md bg-zinc-800 flex items-center gap-2'>
                    ...
                    <button type='button' onClick={() => removeNewEmailToInvite(email)}>
